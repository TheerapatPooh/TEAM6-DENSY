...
export default function Defect({ defects = [] }: defectProps) {
    return (
        <div>
            {
                defects.map((defect) => (
                    <div className="bg-card p-4 rounded-lg shadow-md border-l-8 border-green-500">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center text-black-500 space-x-2">
                                ...
                                <span className="font-semibold text-small text-muted-foreground">09/07/2567 02:00 PM</span>
                            </div>
                            <div>
                                {(() => {
                                    let iconName: string;
